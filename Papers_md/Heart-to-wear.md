...
enabled individuals to monitor their health and
offers potential benefits for remote patient monitoring.
However, the reliability of diagnoses provided by
...
environments.Previous research has focused on
...
Keywords:WearableDevices,Measurement
Accuracy, Heart Rate, Comparative Study
1. Introduction
In recent years, the number of connected wearable
devices has increased rapidly and surpassed the
one-billion-device mark for the first time in 2022
(Research and Markets, 2023).So far, there are
...
especially smartwatches.In addition to examining
the accuracy of the step counter as well as the
...
et al., 2018).The experimental setup is always
...
(e.g.sitting, walking, jogging, cycling, etc.).In
...
they fail to account for the real-world variability
...
elliptical trainers (Mart
 ́
ın-Escudero et al., 2023).
Therefore, they may not accurately reflect the reliability
of the devices in real-life scenarios and fail to
...
measurement accuracy of wearable devices.For
...
Page 3183
URI: https://hdl.handle.net/10125/106768
978-0-9981331-7-1
(CC BY-NC-ND 4.0)
unwanted interference or noise into the captured signal
(Fine et al., 2021; Mart
 ́
ın-Escudero et al., 2023).
...
a controlled environment against recordings in an
...
study.In addition to a standard electrocardiogram,
...
seated period, 4 minutes of treadmill exercise at
...
2022; Mart
 ́
ın-Escudero et al., 2023; Nissen et al., 2022).
However, all of the mentioned studies have
been performed in a controlled environment (e.g.
treadmill, stationary bicycle or elliptical trainer).
Nevertheless, a study by Cosoli et al. (2022) investigates
the measurement accuracy of wearable devices of
swimming athletes.In their study, they evaluated
...
on the accuracy of the smartwatches.In fact, the
...
Page 3184
All test persons are non-smokers and physically fit.
...
as non-dominant wrist and while the right wrist is
considered as dominant wrist.
Table 1.Participants Characteristics.
Characteristicμ±σValue Range
Age (Years)32.80±15.03[21; 58]
Height (cm)170.80±8.13[160; 190]
Weight (kg)68.20±15.73[48; 103]
3.2. Procedure
This study aims to assess the accuracy of
heart rate measurements obtained from three distinct
smartwatches.Each participant underwent a total
...
non-dominant wrist. In this way, we could analyze
...
ensured that there was no personal or identifiable
...
Enduro 2 and a Polar Pacer Pro as our testing
devices.All three watches are from different
manufacturers in the wearable devices market segment
and represent the latest generation of commercially
...
strap. It is considered and used as a benchmark in
...
Page 3185
Figure 1.Excerpt of a sample indoor recording (Apple Watch Ultra left, Polar Pacer Pro right).
...
at timet, then the chest strap measurement against
...
t−i
,
wheresis the number of seconds that have passed
since the last Apple Watch measurement andX
t−i
is the
Polar H10 chest strap measurementiseconds ago. On
...
Overall, the Apple Watch Ultra has the highest
...
Page 3186
Table 2.CCC between the three smartwatches and the Polar H10 chest strap in dependence of the
...
Overall
LeftRightLeftRight
Apple Watch Ultra0.9990.9940.9980.9990.998
Garmin Enduro 2
0.9970.9960.9930.9920.995
Polar Pacer Pro0.9900.8630.9890.9680.957
(a) Apple Watch Ultra
(b) Garmin Enduro 2
(c) Polar Pacer Pro
...
Page 3188
conditions. The Apple Watch Ultra and Garmin Enduro
2 demonstrated high correlation during regular cycling
activities, both indoors and outdoors.These two
...
on heart rate recordings during cycling, it does not
...
temperature range.This limitation means that our
...
performance during cycling activities.It is worth
...
Dooley,E.E.,Golaszewski,N.M.,&
Bartholomew,J.B.(2017).Estimating
AccuracyatExerciseIntensities:A
ComparativeStudyofSelf-Monitoring
...
and the medical revolution.Personalized
Medicine,15(5), 429–448. https://doi.org/10.
2217/pme-2018-0044
Fine,J.,Branan,K.L.,Rodriguez,A.J.,
Boonya-ananta,T.,Ajmal,
Ramella-Roman, J. C., McShane, M. J.,
& Cot
 ́
e, G. L. (2021). Sources of Inaccuracy
...
monitor and an ECG Holter at rest and
...
& Grimsgaard, S. (2018). Using Fitness
TrackersandSmartwatchestoMeasure
...
forHeartRateMeasurementsDuring
CardiopulmonaryExerciseTest.Annals
of Rehabilitation Medicine,46(4), 209–218.
https://doi.org/10.5535/arm.22050
Mart
 ́
ın-Escudero, P., Cabanas, A. M., Dotor-Castilla,
M. L., Galindo-Canales, M., Miguel-Tobal, F.,
Fern
 ́
andez-P
 ́
erez, C., Fuentes-Ferrer, M., &
...
McBride,G.B.(2005).Aproposalfor
strength-of-agreementcriteriaforlin’s
...
uHealth,5(7), e7208. https://doi.org/10.2196/
mhealth.7208
