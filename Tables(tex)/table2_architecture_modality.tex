% ============================================================
% TABLE 2: Architecture and Modality Deep-Dive (Combined)
% ============================================================
% To change text size: modify \small below (options: \tiny, \scriptsize, \footnotesize, \small, \normalsize)
% To change row height: modify \arraystretch{1.15} below (1.0 = normal, higher = taller rows)
% To change column spacing: modify \tabcolsep{3.5pt} below (higher = wider gap between columns)
...
\setlength{\tabcolsep}{3.5pt}           % Column spacing (increase = wider gap)
\renewcommand{\arraystretch}{1.15}      % Row height (1.0 = normal, 1.15 = 15\% taller)
% Use tabularx instead of resizebox - keeps font size at \small
