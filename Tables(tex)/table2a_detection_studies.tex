...
\small
\resizebox{\linewidth}{!}{%
\begin{tabular}{@{} l >{\raggedright}p{1.5cm} >{\raggedright}p{2.0cm} >{\raggedright}p{1.8cm} >{\centering}p{1.0cm} >{\raggedright}p{1.5cm} >{\raggedright}p{1.8cm} >{\raggedright\arraybackslash}p{1.6cm} @{}}
\toprule
