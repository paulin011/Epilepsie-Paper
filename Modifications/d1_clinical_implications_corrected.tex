...
Current wearable approaches address only a subset of seizure types. Accelerometer-based systems detect motor manifestations but cannot identify seizures without movement components. The ECG-based approach by \textcite{reintjesECGBasedDetectionEpileptic2025} demonstrates that autonomic signals can identify some non-motor seizures, but sensitivity for focal aware seizures (51.1\%) remains substantially below that for convulsive seizures (96.7\%).
