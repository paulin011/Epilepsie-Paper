...
\subsection*{Methods}
Following PRISMA guidelines, 13 primary studies (9 detection, 4 forecasting) published between 2013 and 2026 were reviewed. Studies were evaluated following the framwork proposed by \cite{websterAnalyzingPrepareFuture2002} based on the follwing metrics: sensitivity, false alarm rate (FAR), validation methodology, and ILAE phase of development.
