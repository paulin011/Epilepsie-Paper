...
\parencite{beniczkyAutomatedSeizureDetection2021, chenSeizuresDetectionUsing2022}
...
While more complex models can find more subtle patterns, 
they also introduce the "black-box" problem wherein the model lacks transparency 
\parencite{abualrobUnlockingNewFrontiers2025, ghaderiAdvancesMachineLearning2025}. 
The design should incorporate explanations for decisions to ensure
user trust and regulatory compliance 
\parencite{abualrobUnlockingNewFrontiers2025, mironAutonomicBiosignalsSeizure2025}.
