...
\resizebox{\linewidth}{!}{%
\begin{tabular}{@{} l l l l l l >{\raggedright\arraybackslash}p{3.0cm} >{\centering\arraybackslash}p{2.5cm} l l >{\raggedright\arraybackslash}p{3.0cm} @{}}
\toprule
...
\textbf{Reintjes et al. 2025} & ECG anomaly DET & Retro & n=120, 856 szs & Single-lead ECG & Chest & Matrix Profile, MADRID, and TimeVQVAE-AD & 38.0\%/98.16\% & -- & 1.91--39.8/h & Severe sens/FAR trade-off \\
\addlinespace

\textbf{Fine 2025} & Tonic DET & Phase 1 & n=15/3 & 6-axis band & Wrist & ANN (594 feat) & 100\%Test, 96\% complete & -- & 0.23/n, 0.023/h & Small test, Possible overfitting \\
\addlinespace

\textbf{Dong et al. 2026} & Nocturnal severe szs & Prospective & n=68, 1846 szs & NightWatch & Arm & CNN-LSTM & 71.6\% & -- & 0.165/h & Single-center \\
\addlinespace

\textbf{Wang et al. 2025} & Sz DET & -- & n=28, 62 szs & Biovital-P1 & Wrist & LSTM+SVM/LDA & 56.40\% to 95.3\% & -- & 8.5/24h & Hospital only \\
\addlinespace

\textbf{Singh Rathore 2024} & Multimodal DET & Case study & 1 pt, 6 hrs, 3.2M pts & Wearable (EDA+ACC+HR) & -- & MLP & 96.8\% & 94.8\% & -- & Single patient \\
\addlinespace

\textbf{Elemam et al. 2025} & Q+HRV+Audio & Cross-sect & Q:198, HRV:30 & Camera PPG & Thumbs & CNN, rule based & 95.1\% Q, 93-90\% HRV, 92.5\% AUD & 97.1\% Q & -- & Small samples \\
\addlinespace
...
\textbf{Meisel et al. 2020} & LOSO forecast & LOSO CV & n=69, 452 szs & Empatica E4 & Wrist/Ankle & LSTM+1DConv & 51.2\% & -- & TiW 43.7\% & Pediatric \\
\addlinespace
...
\textbf{Spahr et al. 2025} & Indep. test (347 pt) & 26~s median & -- & -- & -- & Phase 2, 2 CSs missed \\
\textbf{Reintjes et al. 2025} & Retro (SeizeIT2) & -- & -- (subgroup) & -- & HMS 86.8 (sens-opt) & 55.6\% pts with >50~BPM HR change \\
\textbf{Fine 2025} & Indep. test (3 pt) & 14~s mean & -- & -- & 95\% CI: 69--100 & Phase 1 only \\
\textbf{Dong et al. 2026} & 10-fold CV & -- & -- & 0.334 & AUC 0.793 & Long-term home \\
\textbf{Wang et al. 2025} & Hospital retro & -- & 4/10 pts & 83--87\% & Acc 97.8\% (pt~26) & Two hospitals \\
\textbf{Singh Rathore 2024} & Train/test split & -- & -- & 94.8\% & Acc 97.4\%, F1 95.6\% & 3.2M data pts, 25k segments \\
\textbf{Elemam et al. 2025} & Cross-sect & $<$2~s & -- & 90.3\% & -- & PPG 15~s only \\
\textbf{Borujeny 2013} & 3-pt retro & -- & 3/3 pts & 100\% & -- & 20 szs total \\
\addlinespace

\textbf{Forecasting Studies} \\
\addlinespace

\textbf{Vieluf et al. 2025} & Retro longitudinal & -- & Sens 82\%, Spec 67\% & 0.89 & F1 0.81 & Daily predictions \\
...
\textbf{Nasseri 2021} & Retro analysis & 33~min mean & 5/6 (83\%) & -- & AUC 0.75 (0.72--0.92) & RNS validation req \\
\textbf{Ode et al. 2023} & Retro & -- & 29/66 & 0.35 & AUC 0.97 & Individual tuning \\
\bottomrule
\end{tabular}%
}
\par\medskip
