...
\resizebox{\linewidth}{!}{%
\begin{tabular}{@{} l l l l l >{\centering}p{0.7cm} >{\centering}p{0.6cm} >{\centering}p{0.7cm} >{\raggedright\arraybackslash}p{3.2cm} >{\centering}p{1.2cm} >{\centering}p{0.8cm} >{\centering}p{1.2cm} >{\raggedright\arraybackslash}p{2.5cm} @{}}
\toprule
