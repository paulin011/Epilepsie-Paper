...
can converge to meet the strict clinical requirements of high sensitivity
...
Phase 3 denotes prospective, multicenter validation with at least 30 seizures from at least 20 patients achiving 90\% FPR using real-time detection recorded during daily activities so phase 3 excludes EMU (Epilepsy Monitoring Unit) data.
...
unseen data from multiple centers in real-world scenari
