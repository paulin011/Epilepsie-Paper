...
Methodological weaknesses consistently overestimate real-world performance. Eleven of thirteen studies validate in epilepsy monitoring units, which minimize motion artifacts, data loss, and device displacement. The two studies testing in home environments both reported performance degradation. Also, monitoring durations (days to weeks) bias toward common seizure types, while rare events-precisely those most needing detection-remain underrepresented.
