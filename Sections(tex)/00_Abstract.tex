...
\subsection*{Results}
Convulsive seizure detection achieves high sensitivity (71.6-100\%) primarily through accelerometry. Only two systems achieve the ILAE Phase 3 FPR benchmark of 0.008-0.028/h with the caviat that they were only validated in EMU: \textcite{spahrDeepLearningbasedDetection2025} (96\% sensitivity, 0.0054/h) and \textcite{fineDetectionKeyAutomated2025} (100\% sensitivity, 0.023/h). ECG-based detection fails clinically due to excessive false alarm rates ranging from 0.11 to 65.62/h \parencite{reintjesECGBasedDetectionEpileptic2025}.
