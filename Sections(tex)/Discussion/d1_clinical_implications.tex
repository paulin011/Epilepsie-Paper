...
\label{EMU-to-home}
The detection literature demonstrates that clinically acceptable FPR is achievable with accelerometer-based approaches (see Section \ref{sec:results}). Two studies achieve the ILAE Phase 3 FPR target of below 0.1/h using ACC data, suggesting that motor seizure detection has reached sufficient maturity for clinical translation. However, this achievement remains concentrated in controlled EMU settings rather than real-world home environments.
