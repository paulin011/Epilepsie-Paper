...
\label{EMU-to-home}
The detection literature demonstrates that clinically acceptable FPR is achievable with accelerometer-based approaches (see Section \ref{sec:results}). Two studies achieve FPR performance comparable to Phase 3 studies in the ILAE systematic review, which reported 0.2-0.67 false alarms per 24 hours (approximately 0.008-0.028/h) \parencite{beniczkyAutomatedSeizureDetection2021}. This suggests that motor seizure detection has reached sufficient maturity for clinical translation. However, this achievement remains concentrated in controlled EMU settings rather than real-world home environments.
