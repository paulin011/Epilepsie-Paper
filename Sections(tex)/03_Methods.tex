...
fields:
\begin{enumerate}
  \item \textbf{Study Matrix (Table~\ref{tab:study-matrix}):}
  \begin{itemize}
  ...
  \end{itemize}
  \item \textbf{Detailed Metrics Matrix (Table~\ref{tab:detailed-metrics}):}
  \begin{itemize}
...
The following dimensions were extracted and analyzed to inform the narrative synthesis and dimensional analysis presented in Section~\ref{sec:study-comparison}, complementing the tabular comparison:
\begin{itemize}
