...
Wrist placement was preferred because of patient acceptance and the best availability of consumer devices. The Empatica E4 was used in three studies. The Embrace watch and a Fitbit smartwatch both appear in one study each.


\subsubsection{Detection Performance by Modality}

Single-modality accelerometer approaches achieve strong performance. \textcite{spahrDeepLearningbasedDetection2025} reported 96\% sensitivity with 0.0054/h FPR using only ACC data from the Empatica E4. 
This was the lowest FPR among all detection studies. \textcite{borujenyDetectionEpilepticSeizure2013} reported 85\% sensitivity using 2D ACC, though with only three patients.
