...
Detection and forecasting cannot be directly compared because they use different metrics. Detection sensitivity ranges from 38\% to 100\%. Two forecasting studies report AUC-ROC of 0.74 to 0.75, while other forecasting studies use different metrics (IoC, AUC-PR). These metrics assess different constructs.
...
Forecasting shows a consistent performance ceiling across studies. Two forecasting studies using AUC-ROC report values of 0.74 to 0.75 (\textcite{nasseriAmbulatorySeizureForecasting2021}, \textcite{stirlingForecastingSeizureLikelihood2021}). This consistency across different methods and modalities suggests a fundamental limit of non-invasive forecasting approaches. \textcite{vielufSeizureMonitoringCombined2025} reports AUC-PR 0.84 rather than AUC-ROC, preventing direct comparison.

Detection has reached a sensitivity ceiling of 100\% but struggles with FPR. The best performing detection study, \textcite{spahrDeepLearningbasedDetection2025}, achieves 96\% sensitivity with 0.0054/h FPR. However, most detection studies report FPR above clinical acceptability thresholds.
