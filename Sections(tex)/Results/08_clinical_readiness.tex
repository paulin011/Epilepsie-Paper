...
\textcite{spahrDeepLearningbasedDetection2025} reported 0.0054/h FPR, which is approximately 10 times below the benchmark. \textcite{fineDetectionKeyAutomated2025} reported 0.023/h FPR, approximately twice below the benchmark. These studies demonstrate that acceptable FPR is achievable with wearable ACC-based approaches.

Six detection studies exceed the clinical FPR benchmark. \textcite{dongTwoLayerEnsembleMethod2022} reported 0.165/h FPR. \textcite{wangEpilepticSeizureDetection2025} reported 0.354/h FPR. \textcite{odeDevelopmentEpilepticSeizure2023} reported 0.85/h FPR. \textcite{reintjesECGBasedDetectionEpileptic2025} reported FPR from 0.11/h to 65.62/h depending on method and configuration.
