...
Forecasting AUC consistently falls between 0.74 and 0.75 regardless of Architecure specifics across studies. This consistency suggests a performance ceiling for non-invasive forecasting approaches using wearable biosignals.
