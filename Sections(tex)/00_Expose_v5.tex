...
The focus of this Literature review is on time‑series deep learning models (CNN/LSTM/TCN)
...
\noindent\textbf{Quality flags:} 
Studies including splits preserving patient specific data, FAR/h reporting 
and external or cross validation will be prefered. A PRISMA-style flow diagram
